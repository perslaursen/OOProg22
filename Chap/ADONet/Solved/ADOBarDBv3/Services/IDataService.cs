...
/// which offers CRUD-like functionality for a specific data type.
/// </summary>
...
public interface IDataService<T> where T : class, IHasId
{
    ...
    /// </summary>
    /// <returns>Object with the given ID, if such an object exists. Otherwise null.</returns>
    T? Read(int id);
    ...
    /// <summary>
    /// Returns all objects stored in the data source.
    /// </summary>
    List<T> GetAll();
}
