...
/// </summary>
public class Drink : IHasId, IDesolvable<DrinkDesolved>
{
    #region Properties
    ...
    public DrinkDesolved Desolve()
    {
        return new DrinkDesolved(
            Id, Name,
            AlcoholicPart?.Id, AlcoholicPartAmount,
            NonAlcoholicPart?.Id, NonAlcoholicPartAmount);
    }
}
