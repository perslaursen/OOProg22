...
//            ResolveIngredientId(alcoholicPartId, ingredients), alcoholicPartAmount, 
//            ResolveIngredientId(nonAlcoholicPartId, ingredients), nonAlcoholicPartAmount);
//    }
...
//    private Ingredient? ResolveIngredientId(int? ingId, List<Ingredient> ingredients)
//    {
//        if (ingId is null)
//            return null;
