...
public abstract class DBMethodsBase<T> where T : IHasId
{
    ...
    /// <summary>
    /// Write a single object of type T to the _tableName table
    /// </summary>
    ...
    /// <summary>
    /// Delete an object matching the given id from the _tableName table
    /// </summary>
    ...
    /// <summary>
    /// Adds actual parameters values to the parameterized query string in the SqlCommand object.
    /// The parameter values are taken from the given object of type T.
    /// </summary>
